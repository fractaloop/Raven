...
import raven.edit.tools.RocketTool;

public class RocketToolAction extends AbstractAction {

	private EditorViewDelegate delegate;

	public RocketToolAction(String text, ImageIcon icon, String description,
